...
class FormItemBuilder {
  constructor(id) {
    this.formItemObj = { id, options: {} }
  }

  static create = id => new FormItemBuilder(id);

  setLabel = (label) => {
    this.formItemObj['label'] = label;
    return this;
  }
  ...
  setChildNode = (reactNode) => {
    this.formItemObj['childNode'] = reactNode;
    this.formItemObj['childNodeProp'] = {};
    return this;
  }

  setChildNodeProp = (prop, value) => {
    this.formItemObj['childNodeProp'][prop] = value;
    return this;
  }
